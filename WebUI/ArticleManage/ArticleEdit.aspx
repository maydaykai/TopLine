    ...
    <form id="form1" runat="server">
        <table cellpadding="0" cellspacing="0" class="editTable">
            ...
            <tr>
                ...
                <td style="text-align: left; padding-left: 5px;">
                    <input id="Button1" type="button" value="提交" runat="server" onserverclick="" class="inputButton" />
                    <input type="button" value="返回" class="inputButton" onclick="window.location.href = '/UserManage/UserManage.aspx?columnId=<%=ColumnId%>    '" />
                </td>
            </tr>
        </table>
    </form>
