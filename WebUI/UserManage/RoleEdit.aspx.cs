        ...
        protected void Operate_Click(object sender, EventArgs e)
        {
            ...
            if (_id > 0)
            {
                ...
                ClientScript.RegisterClientScriptBlock(GetType(), "",
                                                       roleBll.Update(roleModel, hdRightList.Value.Trim())
                                                           ? "MessageAlert('更新成功。','success', '/UserManage/RoleManage.aspx?columnId=" +
                                                             ColumnId + "');"
            ...
            else
            {
                var roleModel = new RoleModel
                    {
                        Name = txtRoleName.Value.Trim(),
                        Description = txtRoleDescription.Value.Trim(),
                        Status = ConvertHelper.ToInt(selStatus.Value.Trim()),
                        CreateTime = DateTime.Now,
                        UpdateTime = DateTime.Now
                    };
                ClientScript.RegisterClientScriptBlock(GetType(), "",
                                       roleBll.Add(roleModel, hdRightList.Value.Trim())
                                           ? "MessageAlert('添加成功。','success', '/UserManage/RoleManage.aspx?columnId=" +
                                                             ColumnId + "');"
