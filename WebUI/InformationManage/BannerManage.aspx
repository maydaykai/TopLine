<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BannerManage.aspx.cs" Inherits="WebUI.InformationManage.BannerManage" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //数据源
            var source = {
                url: '/HanderAshx/AdvertManage/BannerHandler.ashx',
                cache: false,
                datatype: "json",
                root: 'Rows',
                datafields: [
